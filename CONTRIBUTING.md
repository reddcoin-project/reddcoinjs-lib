...
# Contributing to reddcoinjs-lib
Firstly in terms of structure, there is no particular concept of "reddcoinjs developers" in a sense of privileged people.
...
* #reddcoinjs-dev:matrix.org on Matrix (A part of the #reddcoinjs-space:matrix.org "Space")
* #reddcoinjs on libera.chat IRC
...
To contribute a patch, the workflow is as follows:
  ...
  1. Submit a pull request to https://github.com/reddcoin-project/reddcoinjs-lib
...
- `reddcoinjs.script.decompile` is consensus bound only,  it does not reject based on policy.
- `reddcoinjs.script.compile` will try to adhere to bitcoin-core `IsStandard` policies rules. (eg. minimalpush in https://github.com/reddcoin-project/reddcoinjs-lib/pull/638)
